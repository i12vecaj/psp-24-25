...
//iniciamos un control de errores el cual nos permite que el codigo se ejecute perfectamente
    try (DatagramSocket serverSocket = new DatagramSocket(PORT)) {
      ...
      while (true) {
        ...
        //aqui con estas dos siguienetes linea recogemos el mensaje y decimos de quien es el mensje en este caso  lo gestionamos por ip
        ...
        if(message.equals( "salir")){
         ...
         /*aqui recibimos el mensaje que podemos configurar para que el servidor lo reenvie en mayuculas completas o en minuscilas
         * minusculas : String response = message.toLowerCase();
           mayusculas : String response = message.toUpperCase();
           */
