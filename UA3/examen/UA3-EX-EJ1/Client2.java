...
public class Client2 extends JFrame {
    ...
    private void createGUI(String title) {
        ...
        //interfaz simple y usable para implementar el uso de la conexión de manera realista. desplegado en javaswing
    }
    ...
    private void sendMessage() {
        String message = "(Client 2) " + inputField.getText();
        if (!message.isEmpty()) {
            out.println(message);
            inputField.setText("");
        }
    ...
    private class MessageReader implements Runnable {
        ...
        public void run() {
            try {                   /* esta secuencia de código muestra el mensaje en la pantalla
                ...
                JOptionPane.showMessageDialog(Client2.this, "Connection lost!");
            }
        }
    }
